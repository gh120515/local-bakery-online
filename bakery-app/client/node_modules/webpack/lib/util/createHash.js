...
const Hash = require("webpack/lib/util/Hash");
...
/** @type {typeof import("webpack/lib/util/hash/xxhash64") | undefined} */
let createXXHash64 = undefined;
/** @type {typeof import("webpack/lib/util/hash/md4") | undefined} */
let createMd4 = undefined;
/** @type {typeof import("webpack/lib/util/hash/BatchedHash") | undefined} */
	...
	switch (algorithm) {
		...
		case "xxhash64":
			if (createXXHash64 === undefined) {
				createXXHash64 = require("webpack/lib/util/hash/xxhash64");
				if (BatchedHash === undefined) {
					BatchedHash = require("webpack/lib/util/hash/BatchedHash");
				}
			}
			return new /** @type {typeof import("webpack/lib/util/hash/BatchedHash")} */ (
				BatchedHash
			)(createXXHash64());
		case "md4":
			if (createMd4 === undefined) {
				createMd4 = require("webpack/lib/util/hash/md4");
				if (BatchedHash === undefined) {
					BatchedHash = require("webpack/lib/util/hash/BatchedHash");
				}
			}
