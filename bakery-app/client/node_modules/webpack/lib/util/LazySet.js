...
const makeSerializable = require("webpack/lib/util/makeSerializable.js");
...
class LazySet {
	...
	/**
	 * @param {import("webpack/lib/serialization/ObjectMiddleware.js").ObjectSerializerContext} context context
	 */
	serialize({ write }) {
		if (this._needMerge) this._merge();
	...
	/**
	 * @template T
	 * @param {import("webpack/lib/serialization/ObjectMiddleware.js").ObjectDeserializerContext} context context
