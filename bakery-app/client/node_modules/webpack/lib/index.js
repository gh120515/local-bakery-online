...
/** @typedef {import("webpack/declarations/WebpackOptions").ExternalItemFunctionData} ExternalItemFunctionData */
/** @typedef {import("webpack/declarations/WebpackOptions").ExternalItemObjectKnown} ExternalItemObjectKnown */
/** @typedef {import("webpack/declarations/WebpackOptions").ExternalItemObjectUnknown} ExternalItemObjectUnknown */
/** @typedef {import("webpack/declarations/WebpackOptions").ExternalItemValue} ExternalItemValue */
/** @typedef {import("webpack/declarations/WebpackOptions").Externals} Externals */
/** @typedef {import("webpack/declarations/WebpackOptions").FileCacheOptions} FileCacheOptions */
/** @typedef {import("webpack/declarations/WebpackOptions").LibraryOptions} LibraryOptions */
/** @typedef {import("webpack/declarations/WebpackOptions").MemoryCacheOptions} MemoryCacheOptions */
...
/** @typedef {import("webpack/lib/Compilation").EntryOptions} EntryOptions */
/** @typedef {import("webpack/lib/Compilation").PathData} PathData */
/** @typedef {import("webpack/lib/Compiler").AssetEmittedInfo} AssetEmittedInfo */
/** @typedef {import("webpack/lib/MultiStats")} MultiStats */
/** @typedef {import("webpack/lib/NormalModuleFactory").ResolveData} ResolveData */
/** @typedef {import("webpack/lib/Parser").ParserState} ParserState */
/** @typedef {import("webpack/lib/ResolverFactory").ResolvePluginInstance} ResolvePluginInstance */
/** @typedef {import("webpack/lib/ResolverFactory").Resolver} Resolver */
/** @typedef {import("webpack/lib/Watching")} Watching */
/** @typedef {import("webpack/lib/cli").Argument} Argument */
/** @typedef {import("webpack/lib/cli").Problem} Problem */
...
module.exports = mergeExports(fn, {
	...
	get validate() {
		const webpackOptionsSchemaCheck = require("webpack/schemas/WebpackOptions.check");
	...
	dependencies: {
		...
		get HarmonyImportDependency() {
			return require("webpack/lib/dependencies/HarmonyImportDependency");
		},
		get ConstDependency() {
	...
	optimize: {
		...
		get InnerGraph() {
			return require("webpack/lib/optimize/InnerGraph");
		},
	...
	wasm: {
		...
		get EnableWasmLoadingPlugin() {
			return require("webpack/lib/wasm/EnableWasmLoadingPlugin");
		}
	},
	...
	util: {
		...
		get runtime() {
			return require("webpack/lib/util/runtime");
		},
		get serialization() {
	...
	experiments: {
		...
		ids: {
			get SyncModuleIdsPlugin() {
				return require("webpack/lib/ids/SyncModuleIdsPlugin");
			}
		}
	}
});
