...
const { LogType } = require("webpack/lib/logging/Logger");
const AggressiveSplittingPlugin = require("webpack/lib/optimize/AggressiveSplittingPlugin");
const SizeLimitsPlugin = require("webpack/lib/performance/SizeLimitsPlugin");
const { countIterable } = require("webpack/lib/util/IterableHelpers");
const {
	compareLocations,
	compareChunksById,
	compareNumbers,
...
const { makePathsRelative, parseResource } = require("webpack/lib/util/identifier");

/** @typedef {import("webpack-sources").Source} Source */
/** @typedef {import("webpack/lib/Chunk")} Chunk */
/** @typedef {import("webpack/lib/ChunkGroup")} ChunkGroup */
/** @typedef {import("webpack/lib/ChunkGroup").OriginRecord} OriginRecord */
/** @typedef {import("webpack/lib/Compilation")} Compilation */
/** @typedef {import("webpack/lib/Compilation").Asset} Asset */
/** @typedef {import("webpack/lib/Compilation").AssetInfo} AssetInfo */
/** @typedef {import("webpack/lib/Compilation").NormalizedStatsOptions} NormalizedStatsOptions */
...
/** @template T @typedef {import("webpack/lib/util/comparators").Comparator<T>} Comparator<T> */
/** @typedef {import("webpack/lib/util/runtime").RuntimeSpec} RuntimeSpec */
/** @typedef {import("webpack/lib/util/smartGrouping").GroupConfig<any, object>} GroupConfig */
/** @typedef {import("webpack/lib/stats/StatsFactory")} StatsFactory */
/** @typedef {import("webpack/lib/stats/StatsFactory").StatsFactoryContext} StatsFactoryContext */
...
const SIMPLE_EXTRACTORS = {
	compilation: {
		...
		version: object => {
			object.version = require("webpack/package.json").version;
		},
